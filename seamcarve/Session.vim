...
map  :bn
map  :bp
vmap \t :call OCamlPrintType("visual")
nmap \t :call OCamlPrintType("normal")
omap \t :call OCamlPrintType("normal")
...
nnoremap <silent> <F10> :Tlist
nnoremap <silent> <F9> :WMToggle
nnoremap <silent> <F7> :BufExplorer
...
silent only
cd ~/Projects/seamcarve
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +66 cmdline_resizer.ml
badd +130 seamcarving.ml
badd +0 carve.ml
args cmdline_resizer.ml
edit carve.ml
...
silent! normal! zE
let s:l = 33 - ((25 * winheight(0) + 25) / 51)
